  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        title: const Center(child: Text('Flowers',style: TextStyle(color: Colors.white),)),
      ),
                    ...
                    const Wrap(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Being surrounded by flowers, or even gazing at floral scenes, diminishes tension, anxiety, and worry while enhancing feelings of joy and tranquility',
                            style: TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: 15,
                            ),
